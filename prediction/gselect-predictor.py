...
def gselectBranchPredictor(num_entries, history_length):
    gshare_predictor = Gselect()
...
def Gselect():
    return {
        ...
        "history_length": 10,
        "num_entries": 1024,
        "plot_path": "./task_output/gselect_performance_plot.png",
    }
...
gselect_predictor = gselectBranchPredictor(num_entries=1024, history_length=10)
system.cpu.branchPred = LocalBP()

os.system(f"python3 {executable}/gselect.py")
...
total_branches = gselect_predictor.totalBranches
mispredicted_branches = gselect_predictor.mispredictedBranches
